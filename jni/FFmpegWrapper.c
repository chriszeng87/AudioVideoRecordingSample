...
const char *sampleFilePath = "/sdcard/sample.flv";
 ...
 */
void Java_com_chris_video_FFmpegWrapper_prepareAVFormatContext(JNIEnv *env, jobject obj, jstring jOutputPath){
    init();
...
void Java_com_chris_video_FFmpegWrapper_setAVOptions(JNIEnv *env, jobject obj, jobject jOpts){
 ...
 */
void Java_com_chris_video_FFmpegWrapper_writeAVPacketFromEncodedData(JNIEnv *env, jobject obj, jobject jData, jint jIsVideo, jint jOffset, jint jSize, jint jFlags, jlong jPts){
    if(packet == NULL){
 ...
 */
void Java_com_chris_video_FFmpegWrapper_finalizeAVFormatContext(JNIEnv *env, jobject obj){
