...
//    private Stream mStream;
    ...
    public SessionConfig(String outputFile) {
        mVideoConfig = new VideoEncoderConfig(480, 640, 500 * 1000);
...
//        outputDir.mkdir();
        mMuxer = FFmpegMuxer.create(outputFile,//.getAbsolutePath(), 
        		Muxer.FORMAT.MPEG4);
//        mStream = new Stream();
    }
...
//                mMuxer = AndroidMuxer.create(createRecordingPath(outputLocation), Muxer.FORMAT.MPEG4);
        ...
        private void setMetaDefaults() {
            ...
            mAdaptiveStreaming = (Build.VERSION.SDK_INT >= 19);
